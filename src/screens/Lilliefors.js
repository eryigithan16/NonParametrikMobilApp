...
import CompLF from '../components/CompLF';
import {lilliefors} from '../funcs'

class Lilliefors extends Component{
    constructor(props) {
    ...
    calculateFunc=()=>{
        const result = lilliefors(this.state.dataX);
    ...
    render(){
        return (
            <View style={styles.MainContainer}>
                ...
                <View>
                    {this.state.show ? <CompLF result={this.state.result}/>: null }
                </View>
